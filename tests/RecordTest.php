...
class RecordTest extends TestCase
{
  public function testNewRecordingObject()
  {
    ...
    $record = new Record(null, null, null, null, true, $choices, "Please say your account number", null, 5, null, "POST");
  ...
  public function testRecordTranscription()
  {
    ...
    $record = new Record(null, null, null, null, true, $choices, "Please say your account number", null, 5, null, "POST", null, null, $transcription);
